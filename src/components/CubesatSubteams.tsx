...
const subteams: SubteamInfo[] = [
    {
        ...
        name: "Structures",
        description: 
        `Responsible for designing and building the satellite's physical framework, ensuring it 
    ...
    },
    {
        ...
        team: "Mechanical",
        description: 
        `Manages the satellite's temperature, using materials and designs to keep components 
    ...
    },
    {
        ...
        team: "Electrical",
        description: 
        `Handles data transmission between the satellite and ground stations, including sending 
    ...
    },
    {
        ...
        team: "Electrical",
        description: 
        `Generates, stores, and distributes electrical energy, typically using solar panels and 
    ...
    },
    {
        ...
        team: "Software",
        description: 
        `Ensures all subsystems work together seamlessly, coordinating interfaces, testing, and 
    ...
    },
    {
        ...
        team: "Software",
        description:
        `Develops the onboard software that controls satellite operations, processes data, and 
    ...
    },
    {
        ...
        team: "Payload",
        description:
        `Determines and controls the satellite's orientation in space, using sensors and reaction 
    ...
    },
    {
        ...
        team: "Payload",
        description:
        `Encompasses overarching project management tasks, including mission planning, scheduling, 
                ...
                <Dialog>
                    <DialogTrigger>
                        <div className="w-72 flex flex-col items-center justify-center gap-5 rounded-2xl p-5 border-2 border-white/30"> 
                            <div>
                                <Icon className="w-20 h-20" color={subteam.color} strokeWidth={1}/>
                            </div>
                            <div>
                    ...
                    <DialogHeader>
                        <DialogTitle style={{ color: subteam.color }}>{subteam.name}</DialogTitle>
