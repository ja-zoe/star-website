...
- [ ] R2.1 — Eboard image optimization — resize + WebP the 8 portraits (~47 MB → <1 MB)
- [ ] R2.2 — Code splitting — lazy-load routes + defer three.js (CanvasRevealEffect) off initial chunk
